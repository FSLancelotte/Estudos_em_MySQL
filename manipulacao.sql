...
INSERT INTO funcionarios(nome, cpf, data_nascimento, endereco, telefone, email, cargo, salario, data_adimissao)
					VALUES ('Ricardo Sousa', '111.222.333-44', '1992-05-12', 'Rua Harmonia 157, São Paulo',
                        '11987651234', 'ricardo.sousa@email.com', 'Chefe de Cozinha', 6000.00, '2019-03-15');
...
-- Inserção de informação de produtos
...
INSERT INTO pedidos (id_cliente, id_funcionario, id_produto, quantidade, data_pedido, status)
VALUES
...
-- Verificando os ids das tabelas
...
-- Atualizando cargo e salário de um funcionário

SET SQL_SAFE_UPDATES = 0; -- Removendo o safe updates para realizar as operações requisitadas
...
-- Atualizando todos os pedidos com data anterior a '2024-07-06' para 'Concluído'
